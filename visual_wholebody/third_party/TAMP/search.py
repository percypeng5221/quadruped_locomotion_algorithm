...
# configure env grid
num_envs = 152 # first: target(blue)    second: current(red)    rest: planning(green)
...
object_choice_tensor = torch.randint(0, 3, (num_envs, )).to(device)
object_choice_tensor[0] = 0
...
while not gym.query_viewer_has_closed(viewer):
    ...
    box_pos = rb_states[[sublist[choice.item()] for sublist, choice in zip(box_idxs, object_choice_tensor)], :3]
    box_rot = rb_states[[sublist[choice.item()] for sublist, choice in zip(box_idxs, object_choice_tensor)], 3:7]
    # print("best_combination", best_combination)
    box_pos[1] = rb_states[box_idxs[1][best_combination[0]], :3]
    box_rot[1] = rb_states[box_idxs[1][best_combination[0]], 3:7]
    ...
    grasp_choice_tensor[1] = best_combination[1]
