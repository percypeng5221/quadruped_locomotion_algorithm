...
def inference(view_points,
    ...
    with torch.no_grad():
        ...
        print("type(loc_map): ", type(loc_map))
        mask = np.zeros_like(loc_map, dtype=bool)
        mask[100:200, 50:150] = True  # Mark the area to retain

        # Zero out everything except the masked area
        loc_map[~mask] = 0
